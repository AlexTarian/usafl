      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Visibility(
              visible: endAutomatic.isAfter(
                  DateTime(startAutomatic.year, startAutomatic.month + 10, startAutomatic.day)),
              child: const Text(
            ...
            const SizedBox(height: 10.0),
            Visibility(
              visible: double.tryParse(widget.wageRate.text)! < double.tryParse(widget.aewr.text)!,
              child: Text(
